...
SELECT * FROM kitaplik ORDER BY yayin_yili ASC;
...
SELECT * FROM kitaplik ORDER BY yayin_yili DESC;
...
SELECT * FROM kitaplik WHERE yazar = 'Fyodor Dostoyevski' ORDER BY yayin_yili ASC;
...
SELECT yazar FROM kitaplik ORDER BY yazar DESC;
...
SELECT yazar FROM kitaplik WHERE yazar BETWEEN 'K' AND 'T' ORDER BY yazar DESC;
...
SELECT kitap_adi FROM kitaplik WHERE yazar = 'Lev Tolstoy' ORDER BY kitap_adi ASC;
...
SELECT yazar, kitap_adi FROM kitaplik ORDER BY yazar, kitap_adi ASC;
 ...
 */
 ...
 SELECT * FROM kitaplik ORDER BY yayin_yili DESC , yazar ASC;
